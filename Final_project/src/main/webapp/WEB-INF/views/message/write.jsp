...
<form  action="/message/insert" method="post" autocomplete="off" enctype="">
	...
	<div class="form-group">
		<div class="form-row">
			<div class="col-3">
				<input type="text" name="recipient" id="recipient" class="form-control" placeholder="받을사람 입력" />
			</div>
			<div class="col-9">
				<select multiple class="form-control" id="list" name="recipients">
