...
public class CommonService {
	...
	public List findZipcode(String word) {
		...
		*/
		...
		URI url =  UriComponentsBuilder.fromHttpUrl("http://www.juso.go.kr/addrlink/addrLinkApi.do")
	...
	//	String rst = rest.getForObject(url, String.class);
			Map rst = rest.getForObject(url, Map.class);
